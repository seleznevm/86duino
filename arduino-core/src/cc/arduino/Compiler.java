    ...
    */
    ...
    if (result != 0) {
      ...
      if (board.getAliasName() != null)
        re = new RunnerException(I18n.format(tr("Error compiling for board {0}."), board.getAliasName()));
      else
        re = new RunnerException(I18n.format(tr("Error compiling for board {0}."), board.getName()));
      re.hideStackTrace();
      throw re;
    }
  }
