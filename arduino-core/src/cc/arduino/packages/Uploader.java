...
import processing.app.debug.MyMessageSiphon;
...
public abstract class Uploader implements MessageConsumer {
  ...
  public abstract boolean burn86Bootloader(String s) throws Exception;
  ...
  protected boolean executeUploadCommand(String command[]) throws Exception {
    ...
    try {
      ...
      new MyMessageSiphon(process.getInputStream(), this, 100, true);
      new MyMessageSiphon(process.getErrorStream(), this, 100, false);
  ...
  @Override
  public void message(String s, boolean stdout) {  // 86Duino: add "boolean stdout" for different color
    ...
    if (stdout) System.out.print(s); // 86Duino
    else System.err.print(s); // 86Duino
